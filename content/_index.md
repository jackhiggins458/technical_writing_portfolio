...
Here's a few pieces I'm proud of:

📢  [Fastmail customer comms: DNS changes required]( {{< relref "fastmail_customer_comms/index.md" >}} )

💌  [Fastmail help article: Custom swipes]( {{< relref "fastmail_help_article/index.md" >}} )

✏️   [ABS tutorial: Introduction to neural networks]( {{< relref "abs_tutorial/index.md" >}} )

📦  [ABS methodology article: Characteristics of Australian Exporters]( {{< relref "abs_methodology_article/index.md" >}} )

<!--🛸  [Uni assignment: The proof is in the ~~pudding~~ probability]( {{< relref "uni_tpm/index.md" >}} )-->
